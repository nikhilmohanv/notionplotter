export function AreaChartIconBlack(props) {
  return (
    <svg
      {...props}
...
export function AreaChartIconWhite(props) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
...
export function BarChartIconBlack(props) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
...
export function BarChartIconWhite(props) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
...
export function PieChartIconBlack(props) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
...
export function PieChartIconWhite(props) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
...
export function DoughNutBlack(props) {
  return (
    <svg
      {...props}
      width="25px"
...
export function DoughNutWhite(props) {
  return (
    <svg
      {...props}
      width="25px"
